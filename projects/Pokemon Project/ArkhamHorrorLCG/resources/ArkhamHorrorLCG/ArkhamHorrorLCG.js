...
//	this.headerFont = ResourceKit.getFont('ArkhamHorrorLCG/fonts/AHLCGSymbol.ttf', 11.2);
	...
	this.comboClassesBW = new Array( 
		...
		ListItem( 'Cave', @AHLCG-Class-Cave ),
		ListItem( 'Field', @AHLCG-Class-Field ),
		ListItem( 'Forest', @AHLCG-Class-Forest ),
		ListItem( 'Town', @AHLCG-Class-Town ),
		ListItem( 'Water', @AHLCG-Class-Water ),
		ListItem( 'Grave', @AHLCG-Class-Grave ),
		ListItem( 'Ice', @AHLCG-Class-Ice ),
		ListItem( 'Desert', @AHLCG-Class-Desert ),
		ListItem( 'Jungle', @AHLCG-Class-Jungle ),
		ListItem( 'Burned', @AHLCG-Class-Burned ),
		ListItem( 'Lab', @AHLCG-Class-Lab ),
		ListItem( 'Dojo', @AHLCG-Class-Dojo ),
		ListItem( 'Ship', @AHLCG-Class-Ship ) );
